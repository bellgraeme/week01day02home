...
class Functions_Practice < MiniTest::Test
  ...
  #Given the len9gth of a side of a cube calculate the volume
  def test_volume_of_cube()
    volume_of_cube = 2 * 2 * 2
  ...
  def test_volume_of_sphere()
    volume_of_sphere = volume_of_sphere(4)
    assert_equal(268.08257, volume_of_sphere)

  end

  #Given a value in fahrenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    fahrenheit = fahrenheit_to_celsius(43)
    assert_equal(6, fahrenheit)
